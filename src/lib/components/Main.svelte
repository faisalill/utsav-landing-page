...
<div id="main-wrapper">
  <div id="navbar-wrapper" class=" backdrop-blur z-40">
    ...
    >
      ...
      <div id="nav-link-wrapper">
        <div class="flex gap-4" id="nav-links">
          <a href="/" class="link">HOME</a>
          <a href="#events" class="link">EVENTS</a>
          <a href="#theme" class="link">THEME</a>
    ...
    >
      <path
        d="M1906.688,12.029c-1.653-1.78-3.943-0.347-5.823-0.883c-0.623,0.442-0.879,1.208-1.873,1.044
				...
				c-2.107-1.286-4.136,1.014-6.53,0.899c-1.032-0.532-1.426-1.861-2.992-2.075c-1.815,1.799-4.035,1.946-6.656,1.126 c-3.284-1.028-6.238,2.367-9.666,1.103c-1.319,1.573-3.447,0.094-4.576,0.938c-1.846,1.38-3.191-0.94-4.748-0.105
  ...
  <div class="flex flex-col items-center mt-4">
    ...
    <img
      ...
      class="w-[250px] md:w-[500px] h-auto hover:scale-125"
      id="utsav-logo"
    />
    <div class="relative">
      <h1
        class="intro-text absolute text-nowrap -translate-x-1/2 -translate-y-1/2 opacity-0"
        id="intro-theme-text"
      >
        Realms of Time
      </h1>
  ...
  <div class="flex flex-col items-center gap-4">
    <div class="mt-8 md:mt-20 flex justify-center gap-4 md:gap-8">
      <div
        class="font-kenyan_bold text-gradient text-3xl md:text-7xl flex text-center gap-4"
        id="countdown"
      >
        <div class="countdown-param">
          <h2><span id="countdown-days" class="font-angel_raphsody"></span></h2>
          <h4 class="text-xl md:text-4xl font-voyage_bold">Days</h4>
        </div>
        <div class="countdown-param">
          <h2>
            <span id="countdown-hours" class="font-angel_raphsody"></span>
          </h2>
          <h4 class="text-xl md:text-4xl font-voyage_bold">Hours</h4>
        </div>
        <div class="countdown-param">
          <h2>
            <span id="countdown-minutes" class="font-angel_raphsody"></span>
          </h2>
          <h4 class="text-xl md:text-4xl font-voyage_bold">Minutes</h4>
        </div>
        <div class="countdown-param">
          <h2>
            <span id="countdown-seconds" class="font-angel_raphsody"></span>
          </h2>
          <h4 class="text-xl md:text-4xl font-voyage_bold">Seconds</h4>
        </div>
      </div>
    </div>

    <div
      class="bg-amber-900 br bg-opacity-90 h-2 w-1/2 rounded-xl realtive mt-2 md:mt-12"
      id="br"
    />
    ...
    <div class="flex flex-col items-center gap-4" id="about">
      <h1
        class="mt-16 text-4xl md:text-8xl text-gradient font-angel_raphsody hiddenn"
      >
        About Us
      </h1>
    ...
    <div class="flex flex-col items-center gap-4" id="contact">
      <h1
      ...
      <div class="flex flex-col items-center gap-4">
        ...
        >
          ...
          <a class="hiddenn" href="mailto:utsav@bmsce.ac.in"
            >utsav@bmsce.ac.in</a
          >
